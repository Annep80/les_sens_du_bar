...
<form id="contactForm" class="contactForm row justify-content-evenly mb-5 ">
        <h4 class="titleContact text-center">Demander un devis:</h4>
        ...
        <label class="inputForm col-md-7 col-10" for="eventDate">Date de votre évènement: *</label>
        <input class="inputForm col-md-7 col-10" type="date" name="eventDate" min="<?= $minDate ?>" required>
