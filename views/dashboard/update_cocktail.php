        ...
        <form class="" method="post" enctype="multipart/form-data" id="cocktailForm" novalidate>
            <div class="row ">
                ...
                <div id="pictureContainer">
                    ...
                    <input  class="mt-5 col-md-4" type="file" name="pictures_name"  class="pictures_name" id="pictures_name">
                ...
                <div id="nameContainer">
                    ...
                    <input value="<?= $cocktails->name ?>" class="mt-5 col-md-4" pattern="<?= NAME_REGEX ?>" type="text" name="name" class="name" id="name" required>
                    <span id="error_name" class="error-message"><?= $errors['name'] ?? '' ?></span>
                </div>
                <div id="ingredientsContainer">
                    <label class="mt-5 col-md-5" for="ingredients">Ingrédient : *</label>
                    <textarea class="mt-5 col-md-4" type="texte" name="ingredients" pattern="<?= TEXTAREA_REGEX ?>" class="ingredients" maxlength="1000" required><?= $cocktails->ingredients ?></textarea>
                    <span id="error_ingredient" class="error-message"><?= $errors['ingerdient'] ?? '' ?></span>
                </div>
                <div id="stageContainer">
                    <label class="mt-5 col-md-5" for="stages">Etape : *</label>
                    <textarea  class="mt-5 col-md-4" type="texte" name="stages" pattern="<?= TEXTAREA_REGEX ?>" class="stages" required><?= $cocktails->stages ?></textarea>
